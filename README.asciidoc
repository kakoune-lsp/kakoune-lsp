...
[source,sh]
----
curl -O -L https://github.com/kak-lsp/kak-lsp/releases/download/v12.0.0/kak-lsp-v12.0.0-x86_64-apple-darwin.tar.gz
tar xzvf kak-lsp-v12.0.0-x86_64-apple-darwin.tar.gz
...
[source,sh]
----
wget https://github.com/kak-lsp/kak-lsp/releases/download/v12.0.0/kak-lsp-v12.0.0-x86_64-unknown-linux-musl.tar.gz
tar xzvf kak-lsp-v12.0.0-x86_64-unknown-linux-musl.tar.gz

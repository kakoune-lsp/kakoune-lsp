...
[source,sh]
----
curl -O -L https://github.com/kak-lsp/kak-lsp/releases/download/v15.0.1/kak-lsp-v15.0.1-x86_64-apple-darwin.tar.gz
...
[source,sh]
----
wget https://github.com/kak-lsp/kak-lsp/releases/download/v15.0.1/kak-lsp-v15.0.1-x86_64-unknown-linux-musl.tar.gz
...
* `lsp_hover_max_lines` (int): If greater than 0 then limit rendered hover box to the given number of lines. Default is 20.

...
[source,sh]
----
curl -O -L https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.0.2/kakoune-lsp-v18.0.2-x86_64-apple-darwin.tar.gz
tar xzvf kakoune-lsp-v18.0.2-x86_64-apple-darwin.tar.gz
...
[source,sh]
----
wget https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.0.2/kakoune-lsp-v18.0.2-x86_64-unknown-linux-musl.tar.gz
tar xzvf kak-lsp-v18.0.2-x86_64-unknown-linux-musl.tar.gz
# replace `~/.local/bin/` with something on your `$PATH`
mv kak-lsp ~/.local/bin/
----

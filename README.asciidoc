...
----
curl -O -L https://github.com/ul/kak-lsp/releases/download/v5.7.0/kak-lsp-v5.7.0-x86_64-apple-darwin.tar.gz
tar xzvf kak-lsp-v5.7.0-x86_64-apple-darwin.tar.gz
...
----
wget https://github.com/ul/kak-lsp/releases/download/v5.7.0/kak-lsp-v5.7.0-x86_64-unknown-linux-musl.tar.gz
tar xzvf kak-lsp-v5.7.0-x86_64-unknown-linux-musl.tar.gz
...
----
wget https://github.com/ul/kak-lsp/releases/download/v5.7.0/kak-lsp-v5.7.0-x86_64-unknown-freebsd.tar.gz
tar xzvf kak-lsp-v5.7.0-x86_64-unknown-freebsd.tar.gz

...
----
wget https://github.com/ul/kak-lsp/releases/download/v5.2.2/kak-lsp-v5.2.2-x86_64-unknown-linux-musl.tar.gz
tar xzvf kak-lsp-v5.2.2-x86_64-unknown-linux-musl.tar.gz

...
[source,sh]
----
curl -O -L https://github.com/kak-lsp/kak-lsp/releases/download/v11.1.0/kak-lsp-v11.1.0-x86_64-apple-darwin.tar.gz
tar xzvf kak-lsp-v11.1.0-x86_64-apple-darwin.tar.gz
...
[source,sh]
----
wget https://github.com/kak-lsp/kak-lsp/releases/download/v11.1.0/kak-lsp-v11.1.0-x86_64-unknown-linux-musl.tar.gz
tar xzvf kak-lsp-v11.1.0-x86_64-unknown-linux-musl.tar.gz
...
* Comamnds starting with either of `ccls-`, `clangd-`, `ejdtls-`, `texlab-` or `rust-analyzer-`, that provide server specific features.

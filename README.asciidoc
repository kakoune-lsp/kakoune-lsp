...
----
curl -O -L https://github.com/ul/kak-lsp/releases/download/v5.1.3/kak-lsp-v5.1.3-x86_64-apple-darwin.tar.gz
tar xzvf kak-lsp-v5.1.3-x86_64-apple-darwin.tar.gz
...
----
wget https://github.com/ul/kak-lsp/releases/download/v5.1.3/kak-lsp.x86_64-unknown-linux-musl.tar.gz
...
----
wget https://github.com/ul/kak-lsp/releases/download/v5.1.3/kak-lsp-v5.1.3-x86_64-unknown-freebsd.tar.gz
tar xzvf kak-lsp-v5.1.3-x86_64-unknown-freebsd.tar.gz

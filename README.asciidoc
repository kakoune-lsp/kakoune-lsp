...
[ "$(uname -sm)" = 'Darwin arm64' ] &&
    curl -OL https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.1.3/kakoune-lsp-v18.1.3-aarch64-apple-darwin.tar.gz
[ "$(uname -sm)" = 'Darwin x86_64' ] &&
    curl -OL https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.1.3/kakoune-lsp-v18.1.3-x86_64-apple-darwin.tar.gz
[ "$(uname)" = Linux ] &&
    curl -OL https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.1.3/kakoune-lsp-v18.1.3-x86_64-unknown-linux-musl.tar.gz
tar xzvf kakoune-lsp-v18.1.3-*.tar.gz

...
This is a https://microsoft.github.io/language-server-protocol/[Language Server Protocol] client for https://kakoune.org[Kakoune] implemented in https://www.rust-lang.org[Rust].

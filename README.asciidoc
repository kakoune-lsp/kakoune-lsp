...
----
curl -O -L https://github.com/ul/kak-lsp/releases/download/v2.1.0/kak-lsp.x86_64-apple-darwin.tar.gz
...
----
wget https://github.com/ul/kak-lsp/releases/download/v2.1.0/kak-lsp.x86_64-unknown-linux-musl.tar.gz

...
** for the previous five commands, `\*goto*` buffer has `lsp-goto` filetype so you can press `<ret>` on a line or use the `lsp-jump` command
...
** `\*symbols*` buffer has `lsp-goto` filetype so you can press `<ret>` on a line or use the `lsp-jump` command
...
** `\*diagnostics*` buffer has `lsp-goto` filetype so you can press `<ret>` on a line or use the `lsp-jump` command

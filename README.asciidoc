...
----
curl -O -L https://github.com/kak-lsp/kak-lsp/releases/download/v9.0.0/kak-lsp-v8.0.0-x86_64-apple-darwin.tar.gz
...
----
wget https://github.com/kak-lsp/kak-lsp/releases/download/v9.0.0/kak-lsp-v8.0.0-x86_64-unknown-linux-musl.tar.gz

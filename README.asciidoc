...
----
[ $(uname) = Darwin ] &&
    wget https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.0.2/kakoune-lsp-v18.0.2-x86_64-apple-darwin.tar.gz
[ $(uname) = Linux ] &&
...
tar xzvf kakoune-lsp-v18.0.2-x86_64-*.tar.gz

...
----
[ $(uname) = Darwin ] &&
    wget https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.0.3/kakoune-lsp-v18.0.3-x86_64-apple-darwin.tar.gz
[ $(uname) = Linux ] &&
    wget https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v18.0.3/kakoune-lsp-v18.0.3-x86_64-unknown-linux-musl.tar.gz
tar xzvf kakoune-lsp-v18.0.3-x86_64-*.tar.gz

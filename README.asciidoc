...
See the output of `kak-lsp` for the default set of servers and some commented-out alternatives.
...
See the output of `kak-lsp` for the default set of exceptions.

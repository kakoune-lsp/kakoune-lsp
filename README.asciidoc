...
https://clangd.llvm.org/extensions.html#utf-8-offsets[support for UTF-8 offsets via the clangd
protocol extension], or if `kak-lsp.toml` contains `offset_encoding = "utf-8"` for that language
server.

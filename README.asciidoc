...
[ "$(uname -sm)" = 'Darwin arm64' ] &&
    curl -OL https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v19.0.1/kakoune-lsp-v19.0.1-aarch64-apple-darwin.tar.gz
[ "$(uname -sm)" = 'Darwin x86_64' ] &&
    curl -OL https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v19.0.1/kakoune-lsp-v19.0.1-x86_64-apple-darwin.tar.gz
[ "$(uname)" = Linux ] &&
    curl -OL https://github.com/kakoune-lsp/kakoune-lsp/releases/download/v19.0.1/kakoune-lsp-v19.0.1-x86_64-unknown-linux-musl.tar.gz
tar xzvf kakoune-lsp-v19.0.1-*.tar.gz

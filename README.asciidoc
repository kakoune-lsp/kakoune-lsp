...
[source,sh]
----
curl -O -L https://github.com/kak-lsp/kak-lsp/releases/download/v13.0.0/kak-lsp-v13.0.0-x86_64-apple-darwin.tar.gz
tar xzvf kak-lsp-v13.0.0-x86_64-apple-darwin.tar.gz
...
[source,sh]
----
wget https://github.com/kak-lsp/kak-lsp/releases/download/v13.0.0/kak-lsp-v13.0.0-x86_64-unknown-linux-musl.tar.gz
tar xzvf kak-lsp-v13.0.0-x86_64-unknown-linux-musl.tar.gz
